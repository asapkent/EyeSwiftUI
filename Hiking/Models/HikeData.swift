...
extension Hike {
    static func all() -> [Hike] {
        return [
            Hike(name: "Carolina Panthers", imageURL: "carolina-panthers", wins: 16, teamDiscription: "The Carolina Panthers' history formally dates back to 1993, when the NFL awarded the franchise to Charlotte, North Carolina. The Panthers, along with the Jacksonville Jaguars, began play in the 1995 NFL season as expansion teams."),
